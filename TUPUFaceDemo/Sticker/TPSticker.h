...
/**
 贴纸管理，加载等
 */
@interface TPStickersManager : NSObject
 ...
 */
+ (void)loadStickersWithCompletion:(void(^)(NSArray<TPSticker *> *stickers))completion;
...
/**
 一套贴纸
 */
@interface TPSticker : NSObject

/**
 包含的所有部件
 */
@property (nonatomic, readonly) NSArray<TPStickerItem *> *items;
