...
@interface TPTexturesWrapper : NSObject
...
@implementation TPTexturesWrapper
{
    GLuint *_textureArr;
    NSUInteger _size;
}
...
@implementation TPStickerItem (OpenGL)

- (TPTexturesWrapper *)textures
{
    TPTexturesWrapper *wrapper = objc_getAssociatedObject(self, kTexturesWrapperKey);
    if (!wrapper) {
        wrapper = [[TPTexturesWrapper alloc] initWithSize:self.count];
